...
class ProjectParetoSampleSize(object):
    def __init__(self):
    ...
    def read_config(self, identifier, projDir):
        with open("../config/" + __class__.__name__ + ".json") as json_file:
            ...
            self.lagConstScalar = config["lagConstScalar"]
            self.mypConstScalar = config["mypConstScalar"]
            self.sampleSizeList = config["sampleSizeList"]
    ...
    def write_hyperConfig(self):
        ...
        for algoType in self.algoTypeList:
            for sampleSize in self.sampleSizeList:
                for evalType in self.evalTypeList:
                    ...
                    for envType in self.envTypeList:
                        for trialIndex in range(self.numTrialsTrain):
                            ...
                            exprRunDict["paretoType"] = "SampleSize"
                            exprRunDict["methodType"] = "orig"
                            exprRunDict["methodConst"] = "NA" #self.origConstScalar
                            exprRunDict["methodSampleSize"] = sampleSize
                ...
                for evalType in self.evalTypeList:
                    ...
                    for envType in self.envTypeList:
                        for trialIndex in range(self.numTrialsTrain):
                            ...
                            exprRunDict["methodConst"] = self.lagConstScalar
                            exprRunDict["methodSampleSize"] = sampleSize
                            exprRunDict["methodMix"] = "NA"
                            exprRunDict["evalType"] = evalType
                            exprRunDict["envType"] = envType
                ...
                for evalType in self.evalTypeList:
                    ...
                    for envType in self.envTypeList:
                        for trialIndex in range(self.numTrialsTrain):
                            ...
                            exprRunDict["methodConst"] = self.mypConstScalar
                            exprRunDict["methodSampleSize"] = sampleSize
                            exprRunDict["methodMix"] = "NA"
                            exprRunDict["evalType"] = evalType
                            exprRunDict["envType"] = envType
...
if __name__ == "__main__":
    project = ProjectParetoSampleSize()
    projDir = "../../"
    identifier = ""
