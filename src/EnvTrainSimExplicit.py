...
class GroupEnv(object):
    ...
    def create_uniformTransProb(self):
        ...
        print("transProb shape: ", self.transProb.shape)
...
class EnvTrainSimExplicit(object):
    def __init__(self):
        self.path = None
